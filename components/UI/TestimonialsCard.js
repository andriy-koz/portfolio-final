    ...
    <div className='bg-white/75 h-64 w-[83%] mx-auto -skew-x-12 shadow-lg flex justify-center items-center group'>
      <div className='skew-x-12 pr-20 pl-24 mx-auto'>
        <div className='w-max h-max shape-outside rounded-full overflow-hidden -translate-x-4 mt-6 relative'>
          ...
          <h4 className='transition-all duration-300 text-xl absolute top-16 w-32 text-center opacity-0 group-hover:opacity-100 group-hover:-translate-y-7 font-bold'>
            {name}
          </h4>
        </div>
        <div className='text-slate-900 text-left'>
          <h3 className='text-2xl mb-4'>{title}</h3>
          <p className='leading-7 text-xl'>{text}</p>
        </div>
      </div>
    </div>
  );
